<%@ Page Title="" Language="C#" MasterPageFile="~/OptimumMaster.Master" AutoEventWireup="true" CodeBehind="tblContFrdmCapitatedProviders.aspx.cs" Inherits="Contestation.Optimum.tblContFrdmCapitatedProviders" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../Scripts/Optimum/tblContFrdmCapitatedProviders.js"> </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="pageheader">
        Optimum<span>- Capitated Providers</span>
