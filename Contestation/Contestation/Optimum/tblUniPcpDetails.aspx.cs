...
namespace Contestation.Optimum
{
    public partial class tblUniPcpDetails : System.Web.UI.Page
    {
        ...
        private void loadData()
        {
            ...
            lstTableUniPcpDetails = getTableUniPcpDetails.getUniPcpDetails(txtSearchName.Text, (int)_Contestation.OPTIMUM);
        ...
        protected void GridViewUniPcpDetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool success = deleteHandler.DeleteUniPcpDetails(Convert.ToInt64(ID.Text), Session["username"].ToString(), (int)_Contestation.OPTIMUM);
        ...
        protected void GridViewUniPcpDetails_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool success = updateHandler.UpdateUniPcpDetails(UniPcpDetails, Session["username"].ToString(), (int)_Contestation.OPTIMUM);
