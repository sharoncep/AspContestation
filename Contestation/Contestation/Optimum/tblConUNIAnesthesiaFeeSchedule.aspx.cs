...
namespace Contestation.Optimum
{
    public partial class tblConUNIAnesthesiaFeeSchedule : System.Web.UI.Page
    {
        ...
        private void loadData()
        {
            ...
            lstTableConUNIAnesthesiaFeeSchedule = getTableConUNIAnesthesiaFeeSchedule.getConUNIAnesthesiaFeeSchedule(txtSearchName.Text, (int)_Contestation.OPTIMUM);
        ...
        protected void GridViewConUNIAnesthesiaFeeSchedule_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool success = deleteHandler.DeleteConUNIAnesthesiaFeeSchedule(Convert.ToInt64(ID.Text), Session["username"].ToString(), (int)_Contestation.OPTIMUM);
        ...
        protected void GridViewConUNIAnesthesiaFeeSchedule_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool success = updateHandler.UpdateConUNIAnesthesiaFeeSchedule(ConUNIAnesthesiaFeeSchedule, Session["username"].ToString(), (int)_Contestation.OPTIMUM);
