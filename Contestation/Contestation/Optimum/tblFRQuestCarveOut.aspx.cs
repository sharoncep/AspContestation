...
namespace Contestation.Optimum
{
    public partial class tblFRQuestCarveOut : System.Web.UI.Page
    {
        ...
        private void loadData()
        {
            ...
            lstFRQuestCarveOut = getFRQuestCarveOut.getFRQuestCarveOut(txtSearchName.Text, (int)_Contestation.OPTIMUM);
        ...
        protected void GridViewFRQuestCarveOut_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool success = deleteHandler.DeleteFRQuestCarveOut(Convert.ToInt64(ID.Text), Session["username"].ToString(), (int)_Contestation.OPTIMUM);
        ...
        protected void GridViewFRQuestCarveOut_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool success = updateHandler.UpdateFRQuestCarveOut(FRQuestCarveOut, Session["username"].ToString(), (int)_Contestation.OPTIMUM);
