...
namespace Contestation.Optimum
{
    public partial class tblFreedomCensus : System.Web.UI.Page
    {
        ...
        private void loadData()
        {
            ...
            lstFreedomCensus = getFreedomCensus.getFreedomCensus(txtSearchName.Text, (int)_Contestation.OPTIMUM);
        ...
        protected void GridViewFreedomCensus_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool success = deleteHandler.DeleteFreedomCensus(Convert.ToInt64(ID.Text), Session["username"].ToString(), (int)_Contestation.OPTIMUM);
        ...
        protected void GridViewFreedomCensus_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool success = updateHandler.UpdateFreedomCensus(FreedomCensus, Session["username"].ToString(), (int)_Contestation.OPTIMUM);
