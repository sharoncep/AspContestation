...
namespace Contestation.Optimum
{
    public partial class tblMVAAccidentCodes : System.Web.UI.Page
    {
        ...
        private void loadData()
        {
            ...
            lstTableMVAAccidentCodes = getTableMVAAccidentCodes.getMVAAccidentCodes(txtSearchName.Text, (int)_Contestation.OPTIMUM);
        ...
        protected void GridViewMVAAccidentCodes_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool success = deleteHandler.DeleteMVAAccidentCodes(Convert.ToInt64(ID.Text), Session["username"].ToString(), (int)_Contestation.OPTIMUM);
        ...
        protected void GridViewMVAAccidentCodes_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool success = updateHandler.UpdateMVAAccidentCodes(MVAAccidentCodes, Session["username"].ToString(), (int)_Contestation.OPTIMUM);
