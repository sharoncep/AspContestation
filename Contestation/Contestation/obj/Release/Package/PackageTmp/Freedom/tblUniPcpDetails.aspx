<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tblUniPcpDetails.aspx.cs" Inherits="Contestation.Freedom.tblUniPcpDetails" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../Scripts/Freedom/tblUniPcpDetails.js">  </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="pageheader">
        Freedom<span>- PCP Details</span>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Terminated Date">
                    ...
                    <EditItemTemplate>
                        ...
                        <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="lblTerminatedDate" ErrorMessage="Invalid date" Operator="DataTypeCheck" Type="Date"></asp:CompareValidator>
                    </EditItemTemplate>
