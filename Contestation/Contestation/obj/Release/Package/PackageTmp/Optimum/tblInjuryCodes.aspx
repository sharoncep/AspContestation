<%@ Page Title="" Language="C#" MasterPageFile="~/OptimumMaster.Master" AutoEventWireup="true" CodeBehind="tblInjuryCodes.aspx.cs" Inherits="Contestation.Optimum.tblInjuryCodes" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../Scripts/Optimum/tblInjuryCodes.js"> </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="pageheader">
        Optimum<span>- Injury Codes</span>
        <div class="dv_fl_right">
            <a href="Javascript:void(0);" id="aSearch" class="aSearch" title="Search">Search</a>
            <a class="iframe aAdd" href="tblInjuryCodesAdd.aspx" title="Add New">Add</a>
        </div>
    </div>
