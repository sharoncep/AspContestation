$(document).ready(function ($) {
    ...
    //$("#ContentPlaceHolder1_lnkBtnCase1").hover(function () { $("#div1").toggle(); });
    //$("#ContentPlaceHolder1_lnkBtnCase2").hover(function () { $("#div2").toggle(); });
    //$("#ContentPlaceHolder1_lnkBtnCase3").hover(function () { $("#div3").toggle(); });
    //$("#ContentPlaceHolder1_lnkBtnCase4").hover(function () { $("#div4").toggle(); });
    //$("#ContentPlaceHolder1_lnkBtnCase5").hover(function () { $("#div5").toggle(); });
    //$("#ContentPlaceHolder1_lnkBtnCase6").hover(function () { $("#div6").toggle(); });
    //$("#ContentPlaceHolder1_lnkBtnCase7").hover(function () { $("#div7").toggle(); });
    //$("#ContentPlaceHolder1_lnkBtnCase8").hover(function () { $("#div8").toggle(); });
    //$("#ContentPlaceHolder1_lnkBtnCase9").hover(function () { $("#div9").toggle(); });
    //$("#ContentPlaceHolder1_lnkBtnCase10").hover(function () { $("#div10").toggle(); });
    //$("#ContentPlaceHolder1_lnkBtnCase11").hover(function () { $("#div11").toggle(); });

    //$('#lnkBtnCase1').hover(function () { $('#1234').show(1000) }, function () { $('#1234').hide(1000) });

    //$("#lnkBtnCase1").mouseover(function () { $("#1234").css('visibility', 'visible'); });
    //$("#lnkBtnCase1").mouseout(function () { $("#1234").css('visibility', 'hidden'); });


    //$('#lnkBtnCase1').hover(function () { $('#1234').toggle(); });
