...
namespace Contestation.Freedom
{
    public partial class tblFRHProfRate : System.Web.UI.Page
    {
        ...
        private void loadData()
        {
            ...
            lstTableFRHProfRate = getTableFRHProfRate.getFRHProfRate(txtSearchName.Text, (int)_Contestation.FREEDOM);
        ...
        protected void GridViewFRHProfRate_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool success = deleteHandler.DeleteFRHProfRate(Convert.ToInt64(ID.Text), Session["username"].ToString(), (int)_Contestation.FREEDOM);
        ...
        protected void GridViewFRHProfRate_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool success = updateHandler.UpdateFRHProfRate(FRHProfRate, Session["username"].ToString(), (int)_Contestation.FREEDOM);
