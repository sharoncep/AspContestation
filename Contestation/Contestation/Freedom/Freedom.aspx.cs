...
{
    public partial class Freedom : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                pcpCounty = getPcpCounty.getPcpCounty((int)_Contestation.FREEDOM);
        ...
        protected void drpPcpCounty_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            pcpNames = getPcpName.getPcpNames(drpPcpCounty.SelectedItem.ToString(), rbtnlstClaimType.SelectedItem.ToString(), (int)_Contestation.FREEDOM);
        ...
        public void loadData()
        {
            ...
            else
            {
                ...
                lstCase = getCases.getCaseDetails(caseNo, drpPcpName.SelectedValue.ToString(), drpPcpCounty.SelectedItem.ToString(), txtFrom.Text, txtTo.Text, rbtnlstClaimType.SelectedItem.ToString(), (int)_Contestation.FREEDOM);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < rptrDataList.Items.Count; i++)
            {
                ...
                if (chk.Checked)
                {
                    ...
                    bool success = ResultHandler.insertResults(results, Session["username"].ToString(), Session["userid"].ToString(), (int)_Contestation.FREEDOM);
                }
            }
