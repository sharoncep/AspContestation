...
namespace Contestation.Freedom
{
    public partial class tblMVA_FRH : System.Web.UI.Page
    {
        ...
        private void loadData()
        {
            ...
            lstTableMVA_FRH = getTableMVA_FRH.getMVA_FRH(txtSearchName.Text, (int)_Contestation.FREEDOM);
        ...
        protected void GridViewTblMVA_FRH_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool success = deleteHandler.DeleteMVA_FRH(Convert.ToInt64(ID.Text), Session["username"].ToString(), (int)_Contestation.FREEDOM);
        ...
        protected void GridViewTblMVA_FRH_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool success = updateHandler.UpdateMVA_FRH(MVA_FRH, Session["username"].ToString(), (int)_Contestation.FREEDOM);
