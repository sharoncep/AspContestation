...
namespace Contestation.Freedom
{
    public partial class tblModifierListPayment : System.Web.UI.Page
    {
        ...
        private void loadData()
        {
            ...
            lstTableModifierListPayment = getTableModifierListPayment.getModifierListPayment(txtSearchName.Text, (int)_Contestation.FREEDOM);
        ...
        protected void GridViewModifierListPayment_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool success = deleteHandler.DeleteModifierListPayment(Convert.ToInt64(ID.Text), Session["username"].ToString(), (int)_Contestation.FREEDOM);
        ...
        protected void GridViewModifierListPayment_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool success = updateHandler.UpdateModifierListPayment(ModifierListPayment, Session["username"].ToString(), (int)_Contestation.FREEDOM);
