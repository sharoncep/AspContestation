...
namespace Contestation.Freedom
{
    public partial class tblInjuryCodes : System.Web.UI.Page
    {
        ...
        private void loadData()
        {
            ...
            lstTableInjuryCodes = getTableInjuryCodes.getInjuryCodes(txtSearchName.Text, (int)_Contestation.FREEDOM);
        ...
        protected void GridViewTblInjuryCodes_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool success = deleteHandler.DeleteInjuryCodes(Convert.ToInt64(ID.Text), Session["username"].ToString(), (int)_Contestation.FREEDOM);
        ...
        protected void GridViewTblInjuryCodes_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool success = updateHandler.UpdateInjuryCodes(InjuryCodes, Session["username"].ToString(), (int)_Contestation.FREEDOM);
