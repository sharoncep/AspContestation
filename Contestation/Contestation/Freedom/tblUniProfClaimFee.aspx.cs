...
namespace Contestation.Freedom
{
    public partial class tblUniProfClaimFee : System.Web.UI.Page
    {
        ...
        private void loadData()
        {
            ...
            lstTableUniProfClaimFeeSchedule = getTableUniProfClaimFeeSchedule.getUniProfClaimFeeSchedule(txtSearchName.Text, (int)_Contestation.FREEDOM);
        ...
        protected void GridViewUniProfClaimFee_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool success = deleteHandler.DeleteUniProfClaimFeeSchedule(Convert.ToInt64(ID.Text), Session["username"].ToString(), (int)_Contestation.FREEDOM);
        ...
        protected void GridViewUniProfClaimFee_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool success = updateHandler.UpdateUniProfClaimFeeSchedule(UniProfClaimFee, Session["username"].ToString(), (int)_Contestation.FREEDOM);
