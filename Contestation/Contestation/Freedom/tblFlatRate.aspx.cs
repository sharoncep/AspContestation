...
namespace Contestation.Freedom
{
    public partial class tblFlatRate : System.Web.UI.Page
    {
        ...
        private void loadData()
        {
            ...
            lstFlatRate = getFlatRate.getFlatRate(txtSearchName.Text, (int)_Contestation.FREEDOM);
        ...
        protected void GridViewFlatRate_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool success = deleteHandler.DeleteFlatRate(Convert.ToInt64(ID.Text), Session["username"].ToString(), (int)_Contestation.FREEDOM);
        ...
        protected void GridViewFlatRate_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool success = updateHandler.UpdateFlatRate(flatRate, Session["username"].ToString(), (int)_Contestation.FREEDOM);
