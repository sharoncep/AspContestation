...
namespace Contestation.Freedom
{
    public partial class tblContFrdmCapitatedProviders : System.Web.UI.Page
    {
        ...
        private void loadData()
        {
            ...
            lstTableContFrdmCapitatedProviders = getTableContFrdmCapitatedProviders.getContFrdmCapitatedProviders(txtSearchName.Text, (int)_Contestation.FREEDOM);
        ...
        protected void GridViewContFrdmCapitatedProviders_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            bool success = deleteHandler.DeleteContFrdmCapitatedProviders(Convert.ToInt64(ID.Text), Session["username"].ToString(), (int)_Contestation.FREEDOM);
        ...
        protected void GridViewContFrdmCapitatedProviders_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            bool success = updateHandler.UpdateContFrdmCapitatedProviders(ContFrdmCapitatedProviders, Session["username"].ToString(), (int)_Contestation.FREEDOM);
